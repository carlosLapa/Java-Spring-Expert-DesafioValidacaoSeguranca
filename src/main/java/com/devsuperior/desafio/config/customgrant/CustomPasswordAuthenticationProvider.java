package com.devsuperior.desafio.config.customgrant;
...
public class CustomPasswordAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		com.devsuperior.desafio.config.customgrant.CustomPasswordAuthenticationToken customPasswordAuthenticationToken = (com.devsuperior.desafio.config.customgrant.CustomPasswordAuthenticationToken) authentication;
		...
		com.devsuperior.desafio.config.customgrant.CustomUserAuthorities customPasswordUser = new com.devsuperior.desafio.config.customgrant.CustomUserAuthorities(username, user.getAuthorities());
	...
	public boolean supports(Class<?> authentication) {
		return com.devsuperior.desafio.config.customgrant.CustomPasswordAuthenticationToken.class.isAssignableFrom(authentication);
	}
